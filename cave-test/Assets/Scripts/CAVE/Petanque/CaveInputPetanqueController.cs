...
// Manages the controls in the CAVE
public class CaveInputPetanqueController : MonoBehaviour
{
    /// <summary>
    /// Headset position.
    /// </summary>
    ...
    [SerializeField] private GrabObjectPetanque rightGrab;
    [SerializeField] private GrabObjectPetanque leftGrab;
    ...
    private void Update()
    {
        // Moves and rotates with the joysticks
