...
public class CesiumCaveInput : MonoBehaviour
{
    ...
    [SerializeField]
    private List<CesiumGlobeAnchor> locations;
    ...
    */
    ...
    public void Interact(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            ...
            Debug.Log("Flying to " + locations[currentLocationIndex].gameObject.name);
            FlyTo(locations[currentLocationIndex].longitude, locations[currentLocationIndex].latitude, locations[currentLocationIndex].height);
        }
    }
    ...
    public void FlyTo(double destLongitude, double destLatitude, double destHeight)
    {
        Unity.Mathematics.double3 destination = new Unity.Mathematics.double3(destLongitude, destLatitude, destHeight);
